...
class TestPrincipleEngine(unittest.TestCase):
    ...
    def test_get_consistent_response(self):
    ...
    def test_reset_consistency_scores(self):
...
class TestPrincipleGuidedBridgeBuilder(unittest.TestCase):
    ...
    def test_principle_consistency_report(self):
    ...
    def test_get_principle_descriptions(self):
